...
{
  uint256 private _allTokensMinted;
  ...
  function _mintWithTokenURI(
    ...
    onlyMinter
  {
    _mint(to, _allTokensMinted);
    _setTokenURI(_allTokensMinted, tokenURI);
    emit Minted(to, _allTokensMinted, tokenURI);
    _allTokensMinted = _allTokensMinted.add(1);
  }
}
